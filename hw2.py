...
if 'or' in query:
    ...
    for a in range(0, len(myList)):
        ...
        for i, quote in enumerate(data_list):
            found_at = quote.find(myList[a])
            if ( found_at >= 0):
                first.add(i)
                print("found at:",i,data_list[i])
...
if 'and' in query:
    ...
    for a in range(0, len(myList)):
        ...
        searchList.append(first)
    print(searchList)
    op=searchList[0] & searchList[1]
    for r in range(2,len(searchList)):
        op = searchList & searchList[r]
    print("op is",op)
    for val in op:
        print("found at:",str(val),data_list[val])
